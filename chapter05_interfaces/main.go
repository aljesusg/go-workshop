...
import (
	...
	"github.com/aljesusg/go-workshop/chapter05_interfaces/lexus"
	"github.com/aljesusg/go-workshop/chapter05_interfaces/toyota"
	)
...
func main() {
	...
	// car5 := opel.NewCar("car4", 6000, 0.7, "red")
